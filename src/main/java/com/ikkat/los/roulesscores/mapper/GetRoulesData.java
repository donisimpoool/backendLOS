...
public class GetRoulesData implements RowMapper<RoulesData> {
    private String schemaSql;

    public GetRoulesData() {
    ...
    @Override
    public RoulesData mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        RoulesData data = new RoulesData();
        data.setId(id);
