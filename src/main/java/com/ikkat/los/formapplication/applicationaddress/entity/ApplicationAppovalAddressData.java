...
public class ApplicationAppovalAddressData {
    ...
    private RegenciesData regenciessecond;
    private DistrictData districtmain;
    private DistrictData districtsecond;
    private SubdistrictData subdistrictmain;
    ...
    public ProvinceData getProvincemain() {
        return provincemain;
    }

    public void setProvincemain(ProvinceData provincemain) {
        this.provincemain = provincemain;
    }

    public ProvinceData getProvincesecond() {
        return provincesecond;
    }

    public void setProvincesecond(ProvinceData provincesecond) {
        this.provincesecond = provincesecond;
    }

    public RegenciesData getRegenciesmain() {
        return regenciesmain;
    }

    public void setRegenciesmain(RegenciesData regenciesmain) {
        this.regenciesmain = regenciesmain;
    }

    public RegenciesData getRegenciessecond() {
        return regenciessecond;
    }

    public void setRegenciessecond(RegenciesData regenciessecond) {
        this.regenciessecond = regenciessecond;
    }

    public DistrictData getDistrictmain() {
        return districtmain;
    }

    public void setDistrictmain(DistrictData districtmain) {
        this.districtmain = districtmain;
    }

    public DistrictData getDistrictsecond() {
        return districtsecond;
    }

    public void setDistrictsecond(DistrictData districtsecond) {
        this.districtsecond = districtsecond;
    }

    public SubdistrictData getSubdistrictmain() {
        return subdistrictmain;
    }

    public void setSubdistrictmain(SubdistrictData subdistrictmain) {
